...
public class WeatherService extends IntentService {
    ...
    private static final String ACTION_WEATHER_AT = "com.example.geocalc.webservice.action.WEATHER_AT";
    private static final String BASE_URL = "https://api.darksky.net/forecast/DARK_SKY_API_KEY_HERE";
    public static final String BROADCAST_WEATHER = "com.example.geocalc.webservice.action.BROADCAST";
    // TODO: Rename parameters

    private static final String EXTRA_KEY = "com.example.geocalc.webservice.extra.KEY";
    private static final String EXTRA_LAT = "com.example.geocalc.webservice.extra.LAT";
    private static final String EXTRA_LNG = "com.example.geocalc.webservice.extra.LNG";
    private static final String EXTRA_TIME = "com.example.geocalc.webservice.TIME";
